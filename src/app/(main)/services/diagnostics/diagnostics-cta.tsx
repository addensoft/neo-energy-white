 ...
 * to Contact. Used to also cross-link to `/promo`, but that page is
 * temporarily hidden down to just its banner (per direct instruction) —
 * a "See Current Offers" link to a page with no offers on it would read as
 * broken, so it's dropped for now. Restore it once `/promo` has real
 * content live again.
 */
